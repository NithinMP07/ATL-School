        ...
        if ($data->num_rows > 0) {
            while ($result = $data->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td><a href='payment_detailss.php? atlCode=" . $result['ATL_CODE'] . "'>Payment Details</a></td>
                </tr>";
            }
        } else {
...
<script>
        function redirectToPage() {
            window.location.href = 'http://localhost/sparsha/login/employeeE.php'; // Replace with your target page URL
        }
    </script>
</body>
